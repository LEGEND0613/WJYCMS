...
{
	static private $functionLibrary_url = 'http://up.ddogcms.cn/oa/admin.php?m=server&c=sys_file&a=funLib&domain=';
	static private $functions_url = 'http://up.ddogcms.cn/oa/admin.php?m=server&c=sys_file&a=funModules&domain=';
	static private $function_version_file = 'http://up.ddogcms.cn/oa/admin.php?m=server&c=sys_file&a=versionFiles&domain=';
	static private $ifWeidian = 'http://up.ddogcms.cn/oa/admin.php?m=server&c=sys_file&a=haveweidian&domain=';
