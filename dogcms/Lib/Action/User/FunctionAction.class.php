...
class FunctionAction extends UserAction
{
	...
	'wecha_id' => array('neq', '')
		...
		$spr_content = array(
			...
			array('title' => '微信签到', 'url' => U('Signin/lists', array('token' => $token)), 'pic' => '/tpl/static/newswelcome/images/spread_3.png', 'm' => 'signin'),
	...
	public function bomb_ajax()
	{
		...
		if (!empty($_POST['set_id'])) {
			...
			if (($user_arr['winxintype'] == '3') && (C('server_topdomain') == 'dogcms.cn') && empty($_COOKIE[$token . 'set_id'])) {
