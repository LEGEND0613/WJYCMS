...
class LinkAction extends UserAction{
	...
	public function _initialize() {
		...
		if(C('server_topdomain')!='dogcms.cn'){
			//demo settings
			$this->arr = array('game','Invite','Red_packet', 'Seckill','Autumns','Popularity','Helping','Jiugong','MicroBroker','Crowdfunding',"Unitary","DishOut","LivingCircle","Test","Bargain","Service","Hongbao","Micrstore","SeniorScene","SeniorCard","ServiceChat","Voteimg","Cutprice","Person_card","Numqueue","Punish");
	...
	public function keywordModules(){
		...
		array('module'=>'Eqx','linkcode'=>'{siteUrl}/index.php?g=User&m=Eqx&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Eqx'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),// 高级场景用这个
		array('module'=>'Weizhaohuan','linkcode'=>'{siteUrl}/index.php?g=Wap&m=Weizhaohuan&a=index&token='.$this->token.'&wecha_id={wechat_id}','name'=>$this->modules['Weizhaohuan'],'sub'=>1,'canselected'=>0,'linkurl'=>'','keyword'=>'','askeyword'=>1),// 微召唤
...
//外链小工具
	...
	public function OutsideLink(){
		//处理小工具数组文件
			$f = include('./dogcms/Lib/ORG/Func.links.php');
		//取出分类总汇
			$i=0;
