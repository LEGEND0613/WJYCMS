...
class RecognitionAction extends UserAction
{
	...
	public function fuwu_code()
	{
		...
		require './dogcms/Lib/ORG/Fuwu/HttpRequst.php';
		require './dogcms/Lib/ORG/Fuwu/aop/AopClient.php';
		require './dogcms/Lib/ORG/Fuwu/AlipaySign.php';
		$sceneId = (int) $_GET['id'];
		...
		require './dogcms/Lib/ORG/Fuwu/config.php';
