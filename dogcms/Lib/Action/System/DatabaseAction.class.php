...
class DatabaseAction extends BackAction{
 ...
 public function filemd() {
    $md1 = md5_file('./dogcms/Lib/Action/System/UpdateAction.class.php');
	$md2 = md5_file('./dogcms/Lib/Action/System/UpdatecAction.class.php');
	$md3 = md5($md1.$md2);
	return $md3;	
}
  ...
  public function delete(){
    $filename="./dogdata/database/".strtotime($_GET['time']).".sql";
	//dump($filename);
    unlink($filename);
