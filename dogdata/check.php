...
$dirfile_items = array(
  ...
  // 'PDf' => array('type' => 'file', 'path' => './dogdata/'),
  // 'PDdf' => array('type' => 'file', 'path' => './dogdata/database/'),
   
	'PLf' => array('type' => 'file', 'path' => './dogcms/Lib/index.html'),
	
	'PLAf' => array('type' => 'file', 'path' => './dogcms/Lib/Action/index.html'),
	'PLAAf' => array('type' => 'file', 'path' => './dogcms/Lib/Action/Agent/IndexAction.class.php'),
	'PLACf' => array('type' => 'file', 'path' => './dogcms/Lib/Action/Chat/IndexAction.class.php'),
	'PLAFf' => array('type' => 'file', 'path' => './dogcms/Lib/Action/Fuwu/FuwuAction.class.php'),
	'PLAHf' => array('type' => 'file', 'path' => './dogcms/Lib/Action/Home/index.html'),
	'PLAOf' => array('type' => 'file', 'path' => './dogcms/Lib/Action/Other/index.html'),
	'PLASf' => array('type' => 'file', 'path' => './dogcms/Lib/Action/System/index.html'),
	'PLAUf' => array('type' => 'file', 'path' => './dogcms/Lib/Action/User/index.html'),
	'PLAWf' => array('type' => 'file', 'path' => './dogcms/Lib/Action/Wap/index.html'),
	
	'PLMf' => array('type' => 'file', 'path' => './dogcms/Lib/Model/index.html'),
	'PLMOf' => array('type' => 'file', 'path' => './dogcms/Lib/Model/Other/MsgModel.class.php'),
	'PLMUf' => array('type' => 'file', 'path' => './dogcms/Lib/Model/User/index.html'),

	'PLOf' => array('type' => 'file', 'path' => './dogcms/Lib/ORG/index.html'),
	'PLOaef' => array('type' => 'file', 'path' => './dogcms/Lib/ORG/aes/errorCode.php'),
	'PLOAYf' => array('type' => 'file', 'path' => './dogcms/Lib/ORG/Alipay/index.html'),
	'PLOAPf' => array('type' => 'file', 'path' => './dogcms/Lib/ORG/Allinpay/index.html'),
	'PLOFf' => array('type' => 'file', 'path' => './dogcms/Lib/ORG/Fuwu/Message.php'),
	'PLOTf' => array('type' => 'file', 'path' => './dogcms/Lib/ORG/Tenpay/PayResponse.class.php'),
	'PLOTCf' => array('type' => 'file', 'path' => './dogcms/Lib/ORG/TenpayComputer/function.php'),
	'PLOWf' => array('type' => 'file', 'path' => './dogcms/Lib/ORG/WapAlipay/log.txt'),
	'PLOWNf' => array('type' => 'file', 'path' => './dogcms/Lib/ORG/Weixinnewpay/WxPay.pub.config.php'),
	'PLOWPf' => array('type' => 'file', 'path' => './dogcms/Lib/ORG/Weixinpay/WxPayHelper.class.php'),
	'PLOYf' => array('type' => 'file', 'path' => './dogcms/Lib/ORG/Yeepay/Crypt_RSA.php'),
   ...
   'PD' => array('type' => 'dir', 'path' => './dogdata/'),
   'PDd' => array('type' => 'dir', 'path' => './dogdata/database/'),
   
	'PL' => array('type' => 'dir', 'path' => './dogcms/Lib/'),
	
	'PLA' => array('type' => 'dir', 'path' => './dogcms/Lib/Action/'),
	'PLAA' => array('type' => 'dir', 'path' => './dogcms/Lib/Action/Agent/'),
	'PLAC' => array('type' => 'dir', 'path' => './dogcms/Lib/Action/Chat/'),
	'PLAF' => array('type' => 'dir', 'path' => './dogcms/Lib/Action/Fuwu/'),
	'PLAH' => array('type' => 'dir', 'path' => './dogcms/Lib/Action/Home/'),
	'PLAO' => array('type' => 'dir', 'path' => './dogcms/Lib/Action/Other/'),
	'PLAS' => array('type' => 'dir', 'path' => './dogcms/Lib/Action/System/'),
	'PLAU' => array('type' => 'dir', 'path' => './dogcms/Lib/Action/User/'),
	'PLAW' => array('type' => 'dir', 'path' => './dogcms/Lib/Action/Wap/'),
	
	'PLM' => array('type' => 'dir', 'path' => './dogcms/Lib/Model/'),
	'PLMO' => array('type' => 'dir', 'path' => './dogcms/Lib/Model/Other/'),
	'PLMU' => array('type' => 'dir', 'path' => './dogcms/Lib/Model/User/'),

	'PLO' => array('type' => 'dir', 'path' => './dogcms/Lib/ORG/'),
	'PLOae' => array('type' => 'dir', 'path' => './dogcms/Lib/ORG/aes/'),
	'PLOAY' => array('type' => 'dir', 'path' => './dogcms/Lib/ORG/Alipay/'),
	'PLOAP' => array('type' => 'dir', 'path' => './dogcms/Lib/ORG/Allinpay/'),
	'PLOF' => array('type' => 'dir', 'path' => './dogcms/Lib/ORG/Fuwu/'),
	'PLOT' => array('type' => 'dir', 'path' => './dogcms/Lib/ORG/Tenpay/'),
	'PLOTC' => array('type' => 'dir', 'path' => './dogcms/Lib/ORG/TenpayComputer/'),
	'PLOW' => array('type' => 'dir', 'path' => './dogcms/Lib/ORG/WapAlipay/'),
	'PLOWN' => array('type' => 'dir', 'path' => './dogcms/Lib/ORG/Weixinnewpay/'),
	'PLOWP' => array('type' => 'dir', 'path' => './dogcms/Lib/ORG/Weixinpay/'),
	'PLOY' => array('type' => 'dir', 'path' => './dogcms/Lib/ORG/Yeepay/'),
...
function dirfile_check(&$dirfile_items) {
		...
		if($item['type'] == 'dir') {
			...
			if(file_exists(ROOT_PATH.$item_path)) {
				...
				//	if (substr($item_path)
					...
					die;
					//微&信*狗权限检测*weidogs.com*QQ：3 1 0 5 9 2 0 9 7 8
				}
			} else {
				//echo '<br>7';
	...
	echo "<script> alert('所有文件均通过检测，请刷新返回后台首页放心点击升级吧!   微信*狗官方总负责QQ：3105920978  官网：weidogs.com'); </script>"; 
}
