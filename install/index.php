...
//参数设置
define('SOFT_VERSION', '12.0商业加盟版');
define('SOFT_RELEASE', $version);
define('ROOT_PATH', dirname(__FILE__).'/../');//网站根目录
define('SOFT_NAME', '微信狗dogcms微信营销平台安装'.SOFT_VERSION);
...
'license'=>'<div class="license"><h1>系统安装协议</h1>
                <p>版权所有 (c)2012-2015 保留所有权利。 </p>
				<p>感谢您选择dogcms微信营销平台基于 PHP + MySQL   的技术开发，全部源码开放。</p>
			...
			<strong>二、协议许可的权利 </strong>
				...
				<p>2、您可以在协议规定的约束和限制范围内修改微信狗dogcms微信营销平台源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用微信狗dogcms微信营销平台，还是部份栏目使用 微信营销平台，在你使用了微信狗dogcms微信营销平台的网站主页上必须加上微信狗dogcms微信营销平台。</p>
				<p>4、未经官方许可，禁止在微信狗dogcms微信营销平台  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
                ...
                <p align=right>BY 微信狗dogcms微信营销平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 微信狗dogcms微信营销平台V'.SOFT_VERSION.' 安装程序',
...
if (file_exists('../dogdata/install.lock')){
	@header("Content-type: text/html; charset=UTF-8");
	echo "系统已经安装过了，如果要重新安装，那么请删除dogdata目录下的install.lock文件";
	exit;
}
...
if($method == 'show_license') {//声明
	...
	if($submit) {
	 ...
	 //   $db->query("INSERT INTO `{$tablepre}user` (`id`, `username`, `password`, `role`, `status`, `remark`, `last_login_time`, `last_login_ip`, `last_location`) VALUES(1, '".$username."', '".$password."', 5, 1, '', 1383453875, '127.0.0.1', '')");
			//新增一个标识文件，用来屏蔽重新安装
			$fp = @fopen(ROOT_PATH.'dogdata/install.lock','wb+');
			@fclose($fp);
		}else{
...
<meta content="微信狗dogcms微信营销平台" name="Copyright" />
...
?>
			<div class="footer">
			    <p>Powered by 微信狗微信(c) V12.0商业加盟版 2012-2015</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
