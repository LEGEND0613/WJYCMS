...
define('APP_DEBUG',1);
define('APP_NAME', 'cms');
define('CONF_PATH','./../dogdata/conf/');
define('RUNTIME_PATH','./../dogdata/logs/');
define('TMPL_PATH','./../tpl/');
define('HTML_PATH','./../dogdata/html/');
define('APP_PATH','./../dogcms/');
define('CORE','./../dogcms/_Core');
require(CORE.'/dogcms.php');
?>