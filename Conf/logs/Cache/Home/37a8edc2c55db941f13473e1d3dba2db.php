			...
			<form action="/index.php?m=Users&a=checklogin" method="post">
				<div  class="login_fm hide">
					...
					<div  class="login">
						...
						<input type="hidden" name="__hash__" value="6c1c1dfda0c28dd4837d7b4e06f5ea85_dfb6b31ed586098fd9ec0f2e78184e4a" /></form>
					</div>
				</div>
...
<div  class="c_box">
    <div  class="register bg">
        <div  class="register_title">首页 &gt; 会员注册</div>
        <form  id="regform"  name="regform"  method="post"  action="/index.php?m=Users&a=checkreg"  class="demoform">
            <div  class="register_group">
                <label  class="register_label">用户名</label>
                <div  class="registers">
                    <input  type="text"  name="username"  id="username"  datatype="s6-16"  sucmsg="通过验证！"  nullmsg="请输入用户名"  errormsg="长度为6~16位字符，可以为“数字/字母/中划线/下划线”组成">
                    <span  class="red">*</span>
                <span  class="Validform_checktip"></span></div>
            </div>
            <div  class="register_group">
                <label  class="register_label">设置密码</label>
                <div  class="registers">
                    <input  type="password"  name="password"  id="password"  datatype="*6-15"  sucmsg="通过验证！"  nullmsg="请输入密码"  errormsg="长度为*6-15位字符">
                    <span  class="red">*</span>
                <span  class="Validform_checktip"></span></div>
            </div>
            <div  class="register_group">
                ...
                <div  class="registers">
                    <input  type="password"  name="repassword"  id="repassword"  datatype="*"  recheck="password"  errormsg="您两次输入的账号密码不一致！">
                <span  class="Validform_checktip"></span></div>
            </div>
            <div  class="register_group">
                <label  class="register_label">手机</label>
                <div  class="registers">
                    <input  type="text"  name="tel"  id="phone"  datatype="m"  sucmsg="通过验证！"  nullmsg="请输入手机号码"  errormsg="请输入正确的手机号码">
                    <span  class="red">*</span>
                <span  class="Validform_checktip"></span></div>
            </div>
            <div  class="register_group">
                ...
                <div  class="registers">
                    <input  type="text"  name="email"  id="email"  datatype="e"  sucmsg="通过验证！"  nullmsg="邮箱将与支付及优惠相关，请填写邮箱"  errormsg="邮箱将与支付及优惠相关，请填写正确的邮箱">
                    <span  class="red">*</span>
                <span  class="Validform_checktip"></span></div>
            </div>
            <div  class="register_group">
                <label  class="register_label">QQ</label>
                <div  class="registers">
             ...
             <div  class="register_btn">
                 <input  type="submit"  id="register"  class="button"  value="马上注册">
             </div>
        <input type="hidden" name="__hash__" value="6c1c1dfda0c28dd4837d7b4e06f5ea85_dfb6b31ed586098fd9ec0f2e78184e4a" /></form>
    </div>
</div>
	...
	<div  class="foot">
		<div class="footer_text">
			<ul>
				...
				<li><a>意见反馈</a></li>
				<li><a>公司简介</a></li>
				<li><span></span><?php echo C('site_qq');?>@qq.com</li>
