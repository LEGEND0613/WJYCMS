...
<div class="cLineB">
  ...
  <?php elseif($type == 'saddrs'): ?>
  校区管理|== <a href="<?php echo U('School/index',array('token'=>$token ,'type'=>'semester'));?>">学期管理</a>||<a href="<?php echo U('School/index',array('token'=>$token ,'type'=>'theclass'));?>">班级管理</a>||<a href="<?php echo U('School/index',array('token'=>$token,'type'=>'score'));?>">成绩管理</a>||<a href="<?php echo U('School/index',array('token'=>$token,'type'=>'subject'));?>">科目管理</a>||<a href="<?php echo U('School/index',array('token'=>$token,'type'=>'timeframe'));?>">时段管理</a>||<a href="<?php echo U('School/index',array('token'=>$token,'type'=>'week'));?>">星期管理</a>||<a href="<?php echo U('School/index',array('token'=>$token,'type'=>'saddrs'));?>">校区管理</a><?php endif; ?>
