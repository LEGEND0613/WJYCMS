        ...
        <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" name="mobile" id="mobile" value="<?php echo ($s_teachers['mobile']); ?>" class="px"placeholder="请输入联系人手机" data-validation-engine="validate[required,minSize[11],maxSize[11]]" >
                    <span class="maroon">*</span>
                    </td>
                </tr>
