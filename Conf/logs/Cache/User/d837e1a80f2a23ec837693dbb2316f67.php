...
<div class="content">
          ...
          <div class="cLineB">
              <h4 class="left">当前位置：微学校 >> 班级管理</h4>             
              <a href="<?php echo U('School/curriculum_add',array('token'=>$token,'type'=>'curriculum'));?>"class="right btnGreen vm" style="margin-top:-2px">班级添加</a>
              <div class="clr"></div>
          </div>
          <div class="cLineD">
...
<?php if(is_array($market)): $i = 0; $__LIST__ = $market;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><TR>
                  ...
                  <TD><?php echo ($list['cd_name']); ?></TD>
                   -->
                  <TD>
<a href="<?php echo U('School/curriculum_add',array('token'=>$token,'id'=>$list['id'],'bj_id'=>$list['bj_id'],'type'=>'edit'));?>"><font color="red">编辑</font></a> &nbsp;&nbsp;
