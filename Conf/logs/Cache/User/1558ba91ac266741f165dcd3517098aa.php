...
<div class="content">
          ...
          <div class="cLineB">
              <h4 class="left">当前位置：微学校 >> 课程安排</h4>             <a href="<?php echo U('School/syllabus_add',array('token'=>$token,'type'=>'syllabus'));?>"class="right btnGreen vm" style="margin-top:-2px">添加课程</a>
              <div class="clr"></div>
          </div>
          <div class="cLineD">
    ...
    <input type="hidden" name="searchkey[key]" value="syllabus">
        	班级名称:<input size="20" value="" name="searchkey[name]" class="px" style="width:100px;">&nbsp;&nbsp;&nbsp;
        	周天:<input size="20" value=""  name="searchkey[time]" class="px" style="width:80px;">&nbsp;&nbsp;&nbsp;
        	姓名:<input size="20" value="" name="searchkey[phone]" class="px" style="width:80px;">&nbsp;&nbsp;&nbsp;
        	场地:<input size="20" value="" name="searchkey[email]" class="px" style="width:100px;">&nbsp;&nbsp;&nbsp;
           ...
           <div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-top:5px;">注意:支持模糊查询</div>
            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <TBODY>
                ...
                <TD><?php echo ($list['cd_name']); ?></TD>
                <TD><?php echo ($list['bz_name']); ?></TD>      
                  <TD>
<a href="<?php echo U('School/syllabus_add',array('token'=>$token,'id'=>$list['id'],'xq_id'=>$list['xq_id'],'bj_id'=>$list['bj_id'],'type'=>'edit'));?>"><font color="red">编辑</font></a> &nbsp;&nbsp;
<a href="<?php echo U('School/syllabus_details_add',array('token'=>$token,'id'=>$list['id'],'xq_name'=>$list['xq_name'],'bj_id'=>$list['bj_id'],'type'=>'details'));?>"><font color="red">生成课程表</font></a> &nbsp;&nbsp;
<a class="btn" href="<?php echo U('School/del_item',array('token'=>$token,'id'=>$list['id'],'deltype'=>'syllabus'));?>" onclick="return(confirm('确定要删除吗？'))"  title="删除"><font color="#CCC7C7">删除</font></a>
                 </TD>
