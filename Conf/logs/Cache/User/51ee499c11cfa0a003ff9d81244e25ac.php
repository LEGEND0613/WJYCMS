...
<div class="content">
<div class="cLineB">
  <h4>当前位置：微学校 >> <a href="<?php echo U('School/syllabus',array('token'=>$token));?>">课程管理</a> >> <?php if($type == 'edit'): ?>编辑<?php else: ?>新增<?php endif; ?>课程</h4>
 </div>
      ...
      <form class="form" id="formID" method="post" action="" target="_top" enctype="multipart/form-data">
        ...
        <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
            <tbody>
                ...
                <tr>
                    <th width="120">任教星期:</th>
                    <td>
                   <select name="xq_id" id="xq_id">
                    <?php if(is_array($li_week)): $i = 0; $__LIST__ = $li_week;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list['sid']); ?>" <?php if($tcourse['xq_id'] == $list['sid']): ?>selected<?php endif; ?> ><?php echo ($list['sname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                ...
                <tr>
                 ...
                 <tr>
                    <th width="120">任教班级:</th>
                    <td>
                     <select name="bj_id" id="bj_id">
                    <?php if(is_array($li_tcourse)): $i = 0; $__LIST__ = $li_tcourse;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list['bj_id']); ?>" <?php if($tcourse['bj_id'] == $list['bj_id']): ?>selected<?php endif; ?>><?php echo ($list['sname']); ?>:<?php echo ($list['tname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                    <span class="maroon">*</span>
                    </td>
                </tr>
                ...
                <tr>
                    <th width="120">班主任:</th>
                    <td>              
                         <select name="bz_id" id="bz_id">
                        <?php if(is_array($li_teachers)): $i = 0; $__LIST__ = $li_teachers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list['tid']); ?>" <?php if($tcourse['bz_id'] == $list['tid']): ?>selected<?php endif; ?>><?php echo ($list['tname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                    <span class="maroon">*</span>
                    </td>
            </tr>
                ...
                <tr>
                     <th></th>
                    <td>
                   <a href="<?php echo U('School/syllabus',array('token'=>session('token')));?>" class="btnGray vm">取消</a>
                    </td>
                </tr>
            </tbody>
        </table>
