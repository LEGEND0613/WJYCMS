      ...
      <?php else: ?>
        ...
        <?php else: ?>
                ...
                <tr>
                  ...
                  <td><input type="text" required="" name="weixin" value="" class="px" tabindex="1" size="25">　比如：weidogs </td>
                </tr>
                <tr>
                ...
                <tr style="display:none">
                 ...
                 <tr style="display:none">
                  ...
                  <td><input type="text" name="token" value="<?php echo ($tokenvalue); ?>" class="px" tabindex="1" size="40">(填写你的公众号)例：dogcmsweixin,请勿填写文,或者其它特殊字符，此处token和腾讯平台必须一致!</td>
                </tr>
