...
<div class="content">
<div class="cLineB">
  <h4>当前位置：微学校 >> <a href="<?php echo U('School/curriculum',array('token'=>$token));?>">班级管理</a> >>  班级<?php if($type == 'edit'): ?>编辑<?php else: ?>新增<?php endif; ?></h4>
 </div>
      ...
      <form class="form" id="formID" method="post" action="" target="_top" enctype="multipart/form-data">
        ...
        <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                    ...
                    <td>
                     <select name="bj_id" id="bj_id">
                    <?php if(is_array($li_theclass)): $i = 0; $__LIST__ = $li_theclass;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list['sid']); ?>" <?php if($tcourse['bj_id'] == $list['sid']): ?>selected<?php endif; ?>><?php echo ($list['sname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                ...
                <tr>
                    ...
                    <td>              
                        ...
                        <?php if(is_array($li_teachers)): $i = 0; $__LIST__ = $li_teachers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list['tid']); ?>" <?php if($tcourse['tid'] == $list['tid']): ?>selected<?php endif; ?>><?php echo ($list['tname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                    <span class="maroon">*</span>
                    </td>
               </tr>
                <tr>
                    <th width="120">选择科目:</th>
                    <td>
                    <select name="km_id" id="km_id">
                    <?php if(is_array($li_subject)): $i = 0; $__LIST__ = $li_subject;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list['sid']); ?>" <?php if($tcourse['km_id'] == $list['sid']): ?>selected<?php endif; ?> ><?php echo ($list['sname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                    <span class="maroon">*</span>
                    </td>
                </tr>
                <tr>
                    <th width="120">选择学期:</th>
                    <td>
                   <select name="xq_id" id="xq_id">
                    <?php if(is_array($li_semester)): $i = 0; $__LIST__ = $li_semester;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list['sid']); ?>" <?php if($tcourse['xq_id'] == $list['sid']): ?>selected<?php endif; ?> ><?php echo ($list['sname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                    <span class="maroon">*</span>
                    </td>
                </tr>
                ...
                <tr>
                    <th width="120">任教时段:</th>
                    <td>
                    <select name="sd_id" id="sd_id">
                    <?php if(is_array($li_timeframe)): $i = 0; $__LIST__ = $li_timeframe;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list['sid']); ?>" <?php if($tcourse['sd_id'] == $list['sid']): ?>selected<?php endif; ?> ><?php echo ($list['sname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                    <span class="maroon">*</span>
                    </td>
                </tr>
                <tr>
                    <th width="120">场地安排:</th>
                    <td>
                    <select name="cd_id" id="cd_id">
                    <?php if(is_array($li_adress)): $i = 0; $__LIST__ = $li_adress;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list['sid']); ?>" <?php if($tcourse['cd_id'] == $list['sid']): ?>selected<?php endif; ?> ><?php echo ($list['sname']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                    <span class="maroon">*</span>
                    </td>
                </tr>
                ...
                <tr>
                     <th></th>
                    <td>
                   <a href="<?php echo U('School/curriculum',array('token'=>session('token')));?>" class="btnGray vm">取消</a>
                    </td>
                </tr>
            </tbody>
        </table>
