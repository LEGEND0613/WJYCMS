...
<div class="content">
          ...
          <div class="cLineB">
              <h4 class="left">当前位置：微学校 >> 课程表</h4>  
              <a href="<?php echo U('School/syllabus_details_add',array('token'=>$token,'type'=>'add'));?>"class="right btnGreen vm" style="margin-top:-2px">添加课程表</a>
                <div class="cLine">

            <div class="pageNavigator left">

        <a href="<?php echo U('School/syllabus_details',array('token'=>$token,'type'=>'syllabus_details'));?>" class="btnGrayS vm bigbtn">
                    <img src="tpl/User/default/common/images/pic.png" class="vm">切换图表模式
                </a>
    ...
    <input type="hidden" name="searchkey[key]" value="syllabus_details">
    	        日期:<input size="20" value="" onClick="WdatePicker()" name="searchkey[date]" class="px" style="width:80px;">&nbsp;&nbsp;&nbsp;
              ...
              <TBODY>
               ...
               <TD><?php echo ($list['datetime']); ?></TD>  
                ...
                <TD><?php echo ($list['bz_name']); ?></TD>               
                  <TD>
<a class="btn" href="<?php echo U('School/del_item',array('token'=>$token,'id'=>$list['id'],'deltype'=>'syllabus_details'));?>" onclick="return(confirm('确定要删除吗？'))"  title="删除"><font color="#CCC7C7">删除</font></a>
                 </TD>
