...
<div class="content">
<div class="cLineB">
  <h4>当前位置：微学校 >> <a href="<?php echo U('School/syllabus_details',array('token'=>$token));?>">课程管理</a> >> <?php if($type == 'edit'): ?>编辑<?php else: ?>新增<?php endif; ?>课程表</h4>
 </div>
        ...
        <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <select name="sy_id" id="sy_id" data-validation-engine="validate[required]"  data-errormessage-value-missing="必须选择所属班级">	
					<option value="">请选择班级</option>
                    <?php if(is_array($li_tcourse)): $i = 0; $__LIST__ = $li_tcourse;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><option value="<?php echo ($list['id']); ?>" <?php if($tcourse['sy_id'] == $list['id']): ?>selected<?php endif; ?> ><?php echo ($list['bj_name']); ?>:<?php echo ($list['t_name']); ?>:<?php echo ($list['cd_name']); ?>:<?php echo ($list['sd_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                 ...
                 <tr>
                    ...
                    <td>
                    <input type="input" data-validation-engine="validate[required]"  data-errormessage-value-missing="上课日期必填" class="px" id="datetime" value="<?php if($syllabus_details['datetime'] != ''): echo ($syllabus_details['datetime']); endif; ?>" onClick="WdatePicker()" name="datetime">
                    <input name="isnot" id="isnot" type="hidden" value="1" /> 
                    <span class="maroon">*</span>
                    </td>
                </tr>
                ...
                <tr>
                     <th></th>
                    <td>
                   <a href="<?php echo U('School/syllabus_details_list',array('token'=>session('token')));?>" class="btnGray vm">取消</a>
                    </td>
                </tr>
            </tbody>
        </table>
