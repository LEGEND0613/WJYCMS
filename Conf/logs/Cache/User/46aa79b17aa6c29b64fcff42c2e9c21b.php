...
<div class="content">
<div class="cLineB">
<h4>当前位置：微学校 >> <a href="<?php echo U('School/adress',array('token'=>$token));?>">场地管理</a> >> <?php if($type == 'edit'): ?>编辑<?php else: ?>新增<?php endif; ?>场地</h4>
 </div>
      ...
      <form class="form" id="formID" method="post" action="" target="_top" enctype="multipart/form-data">
        ...
        <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tr>
                    ...
                    <td>
                    <input type="text" value="<?php echo ($s_adress['tname']); ?>" id="tname" name="tname" class="px" placeholder="请输入场地名称" data-validation-engine="validate[required,minSize[2]]"
                    ...
                    <td>
                    <input type="text" name="nname" id="nname" value="<?php echo ($s_adress['nname']); ?>" class="px"
				...
				<tr>
                    ...
                    <td>
                    <input type="text" name="jiontime" id="jiontime" class="px" data-validation-engine="validate[required]" placeholder="创建时间必填" data-errormessage-value-missing="创建时间必填" class="px"  value="<?php if($s_adress['jiontime'] != ''): echo ($s_adress['jiontime']); endif; ?>" onClick="WdatePicker()">
                    <span class="maroon">*</span>
                    </td>  
                   ...
                   <select name="isnot" id="isnot"  data-validation-engine="validate[required]"  data-errormessage-value-missing="必须选择是否启用">
                      ...
                      <option value="1" <?php if($s_adress['isnot'] == 1): ?>selected<?php endif; ?>>启用</option>
                      <option value="2" <?php if($s_adress['isnot'] == 2): ?>selected<?php endif; ?>>停用</option>
                    </select>
                    <span class="maroon">*</span>
                    </td>
                </tr>
                 ...
                 <tr>
                    ...
                    <td>        
                    <input type="text" name="type" id="type" value="<?php echo ($s_adress['type']); ?>" class="px"
                    ...
                    <td>
                   <input type="text" name="adress" id="adress" value="<?php echo ($s_adress['adress']); ?>" class="px"
                 ...
                 <tr>
                    ...
                    <td>
<?php if($s_adress['faceimg'] != ''): ?><img class="thumb_img" id="faceimg_src" src="<?php echo ($s_adress['faceimg']); ?>" style="max-height:100px;"><?php endif; ?>
                         <input type="input" class="px" id="faceimg" value="<?php echo ($s_adress['faceimg']); ?>" name="faceimg" data-validation-engine="validate[required,custom[url]]"
                    ...
                    <td>                  
                    <input type="text" name="maxman" id="maxman" value="<?php echo ($s_adress['maxman']); ?>" class="px"
                ...
                <tr>
                    ...
                    <td colspan="4">
                    <textarea name="headinfo" id="headinfo" style="width: 650px; height: 70px; border:1px solid #234; "data-validation-engine="validate[required,minSize[2],maxSize[100]]" placeholder="不能超过100个字" data-errormessage-value-missing="必须填写"><?php echo ($s_adress['headinfo']); ?></textarea>
                    <span class="maroon">*</span>
                    </td>
                </tr>
                 <tr>
              ...
              数字越大,越在前面显示.
                ...
                <tr>
                    ...
                    <td colspan="4">
                    <textarea name="info" id="info" style="width: 105px; height: 370px; " data-validation-engine="validate[required]"  data-errormessage-value-missing="必须填写"><?php echo ($s_adress['info']); ?></textarea>
                    <span class="maroon">*</span>
                    </td>
                </tr>
                ...
                <tr>
                   <th><?php if($s_adress['tid'] != ''): ?><input type="text" hidden name="tid" value="<?php echo ($s_adress['tid']); ?>"><?php endif; ?></th>
                    <td>
                   <a href="<?php echo U('School/adress',array('token'=>session('token')));?>" class="btnGray vm">取消</a>
