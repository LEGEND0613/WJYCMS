...
<div class="content">
          <div class="cLine">
			...
			<a href="<?php echo U('Assistente/add',array('token'=>$token));?>" title="" class="btnGrayS vm bigbtn"><img class="vm" src="./tpl/User/default/common/images/product/add.png">添加店员</a>　
			</div>
			<a href="<?php echo U('Assistente/index',array('token'=>$token));?>" class="right btnGrayS vm" style="margin-top:10px">返回</a>          
			<div class="clr"></div>
          </div>
		   <div style="background:#fefbe4;border:1px solid #f3ecb9;color:#993300;padding:10px;margin-bottom:5px;font-size:12px;">温馨提示：电脑端店员登陆地址&nbsp;&nbsp;&nbsp;<a href="/index.php?m=Index&a=staff_login&token=<?php echo ($token); ?>" target="_blank"><?php echo ($f_siteUrl); ?>/index.php?m=Index&a=staff_login&token=<?php echo ($token); ?></a>
			</div> 
          <div class="msgWrap">
