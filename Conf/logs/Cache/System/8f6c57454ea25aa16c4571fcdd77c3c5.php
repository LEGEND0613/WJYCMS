...
<head>
	...
	<title><?php echo ($f_siteName); ?>-dogcms后台管理系统</title>
	<meta name="keywords" content="<?php echo ($f_siteName); ?>-dogcms后台管理系统" />
	<meta name="description" content="<?php echo ($f_siteName); ?>-dogcms后台管理系统" />
	...
	<style type="text/css">
		.top{background:url(http://test1.weidogs.com/tpl/System/common/images/topbg.jpg) no-repeat;height:92px;}
	</style>
</head>
<body class="showmenu" style="overflow:hidden;">
				...
				<div id="header">
					<div class="top">
						<a href="/" class="logo" title="首页">首页</a>
						 <div class="login">
							<li>您好：<b><?php echo (session('username')); ?></b> ，欢迎使用微信狗！</li>	
							<li><a href="/index.php" target="_blank"> 前台首页</a></li>
							<li><a href="http://www.weidogs.com/" target="_blank">官方论坛</a></li>
					...
					<div class="topnav"><p><a href="#" id="togglemenu">隐藏菜单</a>&nbsp;<span class="fr"><a href="http://www.weidogs.com/help" target="_blank" style="color:red">微信狗快速入门手册</a></span>                    					</div>
					<div class="fr"></div>
				</div>
				<i class="tico"></i>
			</td>
		...
		<tr>
			<td>
				<div id="footer">
					...
					<p class="fr"> Copyright &copy; 2012-2013 微信狗版权所有  </p>
				</div>
			</td>
		</tr>
	</table>
	<?php if(!empty($content)): ?><!--ad start-->
		...
		<div id="ad2" style="position:fixed; text-align:center; width:100%; top:140px; z-index:30001">
			<a href="http://up.dogcms.cn/oa/admin.php?m=notice&c=view&a=index&id=<?php echo ($content["id"]); ?>" target="_blank"><img src="<?php echo ($content["image"]); ?>" /></a>
		</div>
