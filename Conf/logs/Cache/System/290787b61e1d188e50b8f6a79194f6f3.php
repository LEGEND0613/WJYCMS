...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    <tr> 
      ...
      <td><input type="radio" name="dogcms_debug" value="1" <?php if(C('dogcms_debug')==='1')echo checked; ?> /> 开启调试 <input type="radio" name="dogcms_debug" value="0" <?php if(C('dogcms_debug')==='0')echo checked; ?> /> 关闭调试<span>&nbsp;&nbsp;打开调试模式后，如果系统有问题就能看到具体问题，需要微-信-狗售后排查问题的时候开启</span>
	  </td>
    </tr>
	 <tr> 
      <td  height="48" align="right"><strong>文件调用设置</strong></td>
      <td><input type="radio" name="STATICS_PATH" value="1" <?php if(C('STATICS_PATH')==='1')echo checked; ?> />使用本地CSS图片文件&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="STATICS_PATH" value="" <?php if(C('STATICS_PATH')==='')echo checked; ?> /> 404远程调用</td>
    </tr>   
    <tr> 
      <td  height="48" align="right"><strong>网站名称：</strong></td>
      <td><input type="text" name="site_name" value="<?php echo ($f_siteName); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：微信狗官网</span>
	  </td>
    </tr>
	 <tr> 
	 ...
	 <tr> 
      ...
      <td><input type="text" name="site_url" value="<?php echo ($f_siteUrl); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://www.dogcms.com</span>
    </tr> 
    <tr> 
   ...
   <tr>  
	<tr> 
      <td  height="48" align="right"><strong>聊天机器人名称：</strong></td>
    ...
    <tr> 
      ...
      <td><input type="text" name="liaotian_key" value="<?php echo C('liaotian_key');?>" class="ipt" size="45" />
        <span>&nbsp;&nbsp;</span>  <a href="http://www.tuling123.com/openapi/record.do?channel=49591" target="_blank">点我注册聊天KEY</a></tr>
	...
	<tr> 
      ...
      <td><input type="text" name="ipc" value="<?php echo C('ipc');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：京IPC备12587号</span>
    </tr>
	<tr> 
      <td  height="48" align="right"><strong>站长QQ：</strong></td>
      <td><input type="text" name="site_qq" value="<?php echo ($f_qq); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例如:QQ:3105920978</span>
    </tr>
    <tr> 
	...
	<tr> 
      ...
      <td><input type="text" name="site_email" value="<?php echo C('site_email');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例如:QQ:server@dogcms.cn</span>
    </tr>
	<tr> 
	...
	<tr> 
      ...
      <td><textarea	 type="text" name="copyright" class="ipt" style="width:450px;height:60px;margin:5px 0 5px 0;" /><?php echo C('copyright');?></textarea><span>&nbsp;&nbsp;例:dogcms版权所有</span>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#FF0000"><b>操作可能被安全软件拦截，请无需担心</b></font>
	  </td>
    </tr>
